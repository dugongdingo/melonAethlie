	...
	public static void main(String[] args) throws FileNotFoundException, XMLStreamException, OWLOntologyCreationException, OWLOntologyStorageException {
		...
		for (Family family : families) {
			...
			plants : for (Plant genus : family.getPlants()) {
				...
				OWLNamedIndividual individual = owlFactory.getOWLNamedIndividual(":" + genus.getName() + "Example", owlPrefixManager);
				owlManager.addAxiom(owlOntology, owlFactory.getOWLClassAssertionAxiom(owlGenusClass, individual));
				...
				if (genus.getMedicalUses() !=  null && ! genus.getMedicalUses().isEmpty()) {
					...
					if (!genus.getMedicalUses().isEmpty()) {
						...
						for (String medicUse : genus.getMedicalUses()) {
							...
							OWLNamedIndividual mUIndividual = owlFactory.getOWLNamedIndividual(":" + medicUse + "Example", owlPrefixManager);
							owlManager.addAxiom(owlOntology, owlFactory.getOWLClassAssertionAxiom(owlmedicUse, mUIndividual));
						}
				...
				if (genus.getUses() !=  null && ! genus.getUses().isEmpty()) {
					...
					if (!genus.getUses().isEmpty()) {
						...
						for (String use : genus.getUses()) {
							...
							OWLNamedIndividual mUIndividual = owlFactory.getOWLNamedIndividual(":" + use + "Example", owlPrefixManager);
							owlManager.addAxiom(owlOntology, owlFactory.getOWLClassAssertionAxiom(owlGenusUse, mUIndividual));
						}
		...
		for(Class e : enums) {
			...
			for(Object value : e.getEnumConstants()) {
				...
				OWLNamedIndividual mUIndividual = owlFactory.getOWLNamedIndividual(":" + value.toString() + "Example", owlPrefixManager);
				owlManager.addAxiom(owlOntology, owlFactory.getOWLClassAssertionAxiom(owlEnumeratedValue, mUIndividual));
			}
		...
		for (Family family : families) {
			for (Plant genus : family.getPlants()) {
				OWLClass owlGenusClass = owlFactory.getOWLClass(":" + genus.getName(), owlPrefixManager);
				OWLIndividual owlIndividual = owlFactory.getOWLNamedIndividual(":" + genus.getName() +"Example", owlPrefixManager);
				if (genus.getNefariousNeighbors() !=  null && !genus.getNefariousNeighbors().isEmpty()) {
					...
					if (!nefariousNeighbors.isEmpty()) {
						...
						range = owlFactory.getOWLObjectSomeValuesFrom(plantHasNefariousNeighbor, range);
						...
						for (OWLNamedIndividual individual : nefariousNeighbors.stream().map(s -> owlFactory.getOWLNamedIndividual(":" + s.getName() + "Example", owlPrefixManager)).collect(Collectors.toSet())) {
							owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(plantHasNefariousNeighbor, owlIndividual, individual));
							break;
						}
					}
				...
				if (genus.getCalendar() != null)
					for (Action action : genus.getCalendar().keySet())
						if (action == Action.HARVEST && genus.getCalendar().get(action) != null && !genus.getCalendar().get(action).isEmpty()) {
							...
							range = owlFactory.getOWLObjectSomeValuesFrom(genusIsHarvestedIn, range);
							...
							for (OWLNamedIndividual individual :  genus.getCalendar().get(action).stream().map(s -> owlFactory.getOWLNamedIndividual(":" + s.toString() + "Example", owlPrefixManager)).collect(Collectors.toSet())) {
								owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusIsHarvestedIn, owlIndividual, individual));
								break;
							}
						}
							...
							OWLClassExpression range = owlFactory.getOWLObjectUnionOf(genus.getCalendar().get(action).stream().map(m -> owlFactory.getOWLClass(":" + m.toString(), owlPrefixManager)).collect(Collectors.toSet()));
							range = owlFactory.getOWLObjectSomeValuesFrom(genusIsSownIn, range);
							...
							for (OWLNamedIndividual individual :  genus.getCalendar().get(action).stream().map(s -> owlFactory.getOWLNamedIndividual(":" + s.toString() + "Example", owlPrefixManager)).collect(Collectors.toSet())) {
								owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusIsSownIn, owlIndividual, individual));
								break;
							}
						}
				...
				if (genus.getDepth() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasDepth, owlIndividual, owlFactory.getOWLLiteral(genus.getDepth())));
				}
				...
				if (genus.getGround() != null) {
					...
					OWLClassExpression range =  owlFactory.getOWLClass(":"+genus.getGround().toString(), owlPrefixManager);
					range = owlFactory.getOWLObjectSomeValuesFrom(genusHasGroundType, range);
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasGroundType, owlIndividual, owlFactory.getOWLNamedIndividual(":"  + genus.getGround().toString() + "Example", owlPrefixManager)));
				...
				if (genus.getSunshineNeeded() != null) {
					...
					OWLClassExpression range =  owlFactory.getOWLClass(":"+genus.getSunshineNeeded().toString(), owlPrefixManager);
					range = owlFactory.getOWLObjectSomeValuesFrom(genusHasSunshineNeeded, range);
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasSunshineNeeded, owlIndividual, owlFactory.getOWLNamedIndividual(":"  + genus.getSunshineNeeded().toString() + "Example", owlPrefixManager)));
				...
				if (genus.getNutrientsNeeded() != null) {
					...
					OWLClassExpression range =  owlFactory.getOWLClass(":"+genus.getNutrientsNeeded().toString(), owlPrefixManager);
					range = owlFactory.getOWLObjectSomeValuesFrom(genusHasNutrientsNeeded, range);
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasNutrientsNeeded, owlIndividual, owlFactory.getOWLNamedIndividual(":"  + genus.getNutrientsNeeded().toString() + "Example", owlPrefixManager)));
				}
				...
				if (genus.getPerennial() != null) {
					...
					OWLClassExpression range =  owlFactory.getOWLClass(":"+genus.getPerennial().toString(), owlPrefixManager);
					range = owlFactory.getOWLObjectSomeValuesFrom(genusHasPerennialType, range);
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasPerennialType, owlIndividual, owlFactory.getOWLNamedIndividual(":"  + genus.getPerennial().toString() + "Example", owlPrefixManager)));
				}
				...
				if (genus.getPhNeeded() != null) {
					...
					OWLClassExpression range =  owlFactory.getOWLClass(":"+genus.getPhNeeded().toString(), owlPrefixManager);
					range = owlFactory.getOWLObjectSomeValuesFrom(genusHasPHNeeded, range);
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasPHNeeded, owlIndividual, owlFactory.getOWLNamedIndividual(":"  + genus.getPhNeeded().toString() + "Example", owlPrefixManager)));
				}
				...
				if (genus.getRootType() != null) {
					...
					OWLClassExpression range =  owlFactory.getOWLClass(":" + genus.getRootType().toString(), owlPrefixManager);
					range = owlFactory.getOWLObjectSomeValuesFrom(genusHasRootType, range);
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasRootType, owlIndividual, owlFactory.getOWLNamedIndividual(":"  + genus.getRootType().toString() + "Example", owlPrefixManager)));
				}
				...
				if(genus.getEdibleParts() != null) {
					...
					if (!genus.getEdibleParts().isEmpty()) {
						...
						range = owlFactory.getOWLObjectSomeValuesFrom(genusHasEdiblePart, range);
						...
						for (OWLNamedIndividual individual : genus.getEdibleParts().stream().map(s -> owlFactory.getOWLNamedIndividual(":" + s.toString() + "Example", owlPrefixManager)).collect(Collectors.toSet())) {
							owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasEdiblePart, owlIndividual, individual));
							 break;
						}
					}
				}
				...
				if(genus.getMultiplications() != null) {
					...
					if (!genus.getMultiplications().isEmpty()) {
						...
						for (OWLNamedIndividual individual : genus.getMultiplications().stream().map(s -> owlFactory.getOWLNamedIndividual(":" + s.toString() + "Example", owlPrefixManager)).collect(Collectors.toSet())) {
							owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(genusHasEdiblePart, owlIndividual, individual));
							break;
						}
					}
				...
				if (genus.getExpectedYield() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasExpectedYield, owlIndividual, owlFactory.getOWLLiteral(genus.getExpectedYield())));
				...
				if (genus.getHeight() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasHeight, owlIndividual, owlFactory.getOWLLiteral(genus.getHeight())));
				}
				...
				if (genus.getLineSpacing() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasLineSpacing, owlIndividual, owlFactory.getOWLLiteral(genus.getLineSpacing())));
				}
				...
				if (genus.getMinimalTemperature() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasMinimalTemperature, owlIndividual, owlFactory.getOWLLiteral(genus.getMinimalTemperature())));
				...
				if (genus.getRowSpacing() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasRowSpacing, owlIndividual, owlFactory.getOWLLiteral(genus.getRowSpacing())));
				...
				if (genus.getSeedConservationDuration() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasSeedConservationDuration, owlIndividual, owlFactory.getOWLLiteral(genus.getSeedConservationDuration())));
				...
				if (genus.getTemperatureToSprout() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasTemperatureToSprout, owlIndividual, owlFactory.getOWLLiteral(genus.getTemperatureToSprout())));
				...
				if (genus.getTimeToSprout() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasTimeToSprout, owlIndividual, owlFactory.getOWLLiteral(genus.getTimeToSprout())));
				...
				if (genus.getWidth() != null) {
					...
					owlManager.addAxiom(owlOntology, owlFactory.getOWLDataPropertyAssertionAxiom(genusHasWidth, owlIndividual, owlFactory.getOWLLiteral(genus.getWidth())));
				...
				if (genus.getBeneficialNeighbors() !=  null && !genus.getBeneficialNeighbors().isEmpty()) {
					...
					if ( ! beneficialNeighbors.isEmpty()) {
						...
						range = owlFactory.getOWLObjectSomeValuesFrom(plantHasBeneficialNeighbor, range);
						...
						for (OWLNamedIndividual individual : beneficialNeighbors.stream().map(s -> owlFactory.getOWLNamedIndividual(":" + s.getName() + "Example", owlPrefixManager)).collect(Collectors.toSet())) {
							owlManager.addAxiom(owlOntology, owlFactory.getOWLObjectPropertyAssertionAxiom(plantHasBeneficialNeighbor, owlIndividual, individual));
							break;
						}
					}
				}
